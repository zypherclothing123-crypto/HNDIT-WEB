            ...
            <form onSubmit={handleReset} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-200 text-slate-900 placeholder:text-slate-400 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#005581]/20 focus:border-[#005581] transition-all"
                />
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 text-center">
                <p className="text-sm text-slate-500">
                  ...
                  <Link href="/auth/login" className="text-[#005581] hover:text-indigo-700 font-bold transition-colors">
                    Sign in
                  </Link>
                </p>
              </div>
